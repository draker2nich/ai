...
import Smart3DViewer from './Smart3DViewer'; // НОВЫЙ ИМПОРТ
...
export default function TShirtPreview({ 
  ...
  const [visualizationMode, setVisualizationMode] = useState('3d'); // Сразу 3D по умолчанию
  ...
  return (
    <div>
      ...
      <div className="relative bg-gradient-to-br from-purple-900/30 via-black/50 to-pink-900/30 rounded-2xl p-8 flex items-center justify-center min-h-[500px] mb-5 border border-purple-500/20 overflow-hidden">
        ...
        {/* Mode Badge */}
        <div className="absolute top-4 right-4 bg-gradient-to-r from-purple-600/30 to-pink-600/30 backdrop-blur-sm px-4 py-2 rounded-xl border border-purple-500/30 z-10">
        ...
        {/* Quality Badge */}
        <div className="absolute bottom-4 right-4 text-xs text-purple-400 bg-black/50 backdrop-blur-sm px-3 py-2 rounded-xl border border-purple-500/30 font-medium z-10">
